...
import { ClientRequestType, unionToClientRequestType, unionListToClientRequestType } from '../../schemas/client/client-request-type';
...
clientRequest(obj:any):any|null {
...
constructor(
  ...
  public clientRequest: ComponentRequestT|ContractRequestT|DisconnectT|GenerateRandDataT|null = null
){}
