...
static createGenerateRandData(builder:flatbuffers.Builder, bytesOffset:flatbuffers.Offset):flatbuffers.Offset {
  GenerateRandData.startGenerateRandData(builder);
  GenerateRandData.addBytes(builder, bytesOffset);
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  const bytes = GenerateRandData.createBytesVector(builder, this.bytes);
